        ...
        */
        ...
        public:
            ...
            */
            ...
            void runPhase1(const std::atomic<bool> &stop, int port, network::ZMQSenderChannel &chl);

            void runPhase2(const std::atomic<bool> &stop, int port, network::ZMQSenderChannel &chl);

            int get_seed_increase()
            {
                return seed_increase_;
            }
        ...
        private:
            ...
            */
            ...
            void dispatch_hash(std::unique_ptr<network::ZMQSenderOperation> sop);
