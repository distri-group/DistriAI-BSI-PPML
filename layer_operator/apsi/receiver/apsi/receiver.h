        ...
        */
        ...
        public:
            ...
            */
            ...
            static void SendHashToServer(std::vector<uint8_t> data, network::NetworkChannel &chl);
            ...
            */
            std::vector<MatchRecord> request_query(
                ...
                network::NetworkChannel &chl, int tds);
            ...
            */
            ...
            static Request CreateHashRequest(std::vector<uint8_t> data);
            ...
            */
            ...
            static std::pair<std::shared_ptr<kuku::KukuTable>, int> threadCuckoo(int table_size,
                                                                                 int hash_func_count,
                                                                                 int attempts,
                                                                                 const std::vector<HashedItem> &items,
                                                                                 int tdnum,
            ...
            */
            std::pair<Request, IndexTranslationTable> create_query(
                const std::vector<HashedItem> &items, int tds, network::NetworkChannel &chl);
