...
bigint Proof::slack(int slack, int sec, int phim)
{
  switch (slack)
  {
    case NONINTERACTIVE_BSI1_SLACK:
      cout << "Computing slack for non-interactive BSI1 proof" << endl;
      return NonInteractiveProof::slack(sec, phim);
    case INTERACTIVE_BSI1_SLACK:
      cout << "Computing slack for interactive BSI1 proof" << endl;
      return InteractiveProof::slack(sec, phim);
    case COVERT_BSI2_SLACK:
      cout << "No slack for covert BSI2 proof" << endl;
      return 0;
    case ACTIVE_BSI2_SLACK:
      cout << "Computing slack for active BSI2 proof" << endl;
