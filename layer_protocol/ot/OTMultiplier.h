...
template <int K, int S> class Bsi2kShare;

template <int K, int S>
class Bsi2kMultiplier: public OTMultiplier<Bsi2kShare<K, S>>
{
    typedef Bsi2kShare<K, S> T;
...
public:
    ...
    Bsi2kMultiplier(OTTripleGenerator<T>& generator, int thread_num);
    ~Bsi2kMultiplier();
};
